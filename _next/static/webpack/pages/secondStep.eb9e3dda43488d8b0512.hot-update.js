...
var SecondStep = function SecondStep() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(function () {
    if (localStorage.getItem('livephoto') === null) {
      ...
      setFile(localStorage.getItem('livephoto'));
    }
  }, []);
